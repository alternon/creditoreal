...
export class FormService {
  ...
  private informacionPersonalFormSource: Subject<FormGroup> = new Subject();
  informacionPersonalForm: Observable<FormGroup> = this.informacionPersonalFormSource.asObservable();
  ...
  constructor(
    ...
    this.informacionPersonalForm.subscribe(form =>
  ...
  stepReady(form: FormGroup, part) {
    switch (part) {
      case 'one': { this.informacionPersonalFormSource.next(form) }
